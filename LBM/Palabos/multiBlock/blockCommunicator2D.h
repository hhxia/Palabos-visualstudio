...
struct BlockCommunicator2D {
    ...
    virtual BlockCommunicator2D<T>* clone() const =0;
    virtual void broadCastScalar(T& scalar, plint fromBlock, MultiBlockManagement2D const& multiBlockManagement) const =0;
    virtual void broadCastVector(T* data, plint length, plint fromBlock,
                                 MultiBlockManagement2D const& multiBlockManagement) const =0;
    virtual void duplicateOverlaps(MultiBlock2D<T>& multiBlock) const =0;
