...
void integrateProcessingFunctional<double>(BoxProcessingFunctional3D<double>* functional,
                                           Box3D domain,
                                           std::vector<MultiBlock3D<double>*> multiBlocks, plint level);
...
void integrateProcessingFunctional<double, descriptors::D3Q19Descriptor,descriptors::D3Q19Descriptor> (
        ...
        Box3D domain,
        MultiBlockLattice3D<double, descriptors::D3Q19Descriptor>& lattice1,
        MultiBlockLattice3D<double, descriptors::D3Q19Descriptor>& lattice2, plint level );
...
void integrateProcessingFunctional<double,3,3> (
        ...
        Box3D domain,
        MultiTensorField3D<double,3>& field1,
        MultiTensorField3D<double,3>& field2, plint level );
...
void integrateProcessingFunctional<double, descriptors::D3Q19Descriptor> (
        ...
        Box3D domain,
        MultiBlockLattice3D<double, descriptors::D3Q19Descriptor>& lattice,
        MultiScalarField3D<double>& field, plint level );
...
void integrateProcessingFunctional<double, descriptors::D3Q19Descriptor,3> (
        ...
        Box3D domain,
        MultiBlockLattice3D<double, descriptors::D3Q19Descriptor>& lattice,
        MultiTensorField3D<double,3>& field, plint level );
...
void integrateProcessingFunctional<double, descriptors::D3Q19Descriptor> (
        LatticeBoxProcessingFunctional3D<double, descriptors::D3Q19Descriptor>* functional,
        Box3D domain, std::vector<MultiBlockLattice3D<double, descriptors::D3Q19Descriptor>*> lattices, plint level );
...
void integrateProcessingFunctional<double> (
        ScalarFieldBoxProcessingFunctional3D<double>* functional,
        Box3D domain, std::vector<MultiScalarField3D<double>*> fields, plint level );
...
void integrateProcessingFunctional<double,3> (
        TensorFieldBoxProcessingFunctional3D<double,3>* functional,
        Box3D domain, std::vector<MultiTensorField3D<double,3>*> fields, plint level );
...
void integrateProcessingFunctional<double, descriptors::D3Q19Descriptor> (
        LatticeDotProcessingFunctional3D<double, descriptors::D3Q19Descriptor>* functional,
        DotList3D const& dotList, std::vector<MultiBlockLattice3D<double, descriptors::D3Q19Descriptor>*> lattices, plint level );
...
void integrateProcessingFunctional<double> (
        ScalarFieldDotProcessingFunctional3D<double>* functional,
        DotList3D const& dotList, std::vector<MultiScalarField3D<double>*> fields, plint level );
...
void integrateProcessingFunctional<double,3> (
        TensorFieldDotProcessingFunctional3D<double,3>* functional,
        DotList3D const& dotList, std::vector<MultiTensorField3D<double,3>*> fields, plint level );


/* *************** Bounded Boxed Data Processor functionals ****************** */

template class BoundedCoupledMultiBlocksProcessingFunctionalOperation3D<double>;

template
void applyProcessingFunctional<double>(BoundedBoxProcessingFunctional3D<double>* functional,
                                       Box3D domain, std::vector<MultiBlock3D<double>*> multiBlocks,
                                       plint boundaryWidth);
template
...
void integrateProcessingFunctional<double> (
        BoundedScalarFieldBoxProcessingFunctional3D<double>* functional,
        Box3D domain, std::vector<MultiScalarField3D<double>*> fields, plint boundaryWidth, plint level );
...
void integrateProcessingFunctional<double,3> (
        BoundedTensorFieldBoxProcessingFunctional3D<double,3>* functional,
        Box3D domain, std::vector<MultiTensorField3D<double,3>*> fields, plint boundaryWidth, plint level );
