...
template<typename T, template<typename U> class Descriptor>
inline T getStoredAverageDensity(BlockLatticeBase3D<T,Descriptor> const& blockLattice) {
...
template<typename T, template<typename U> class Descriptor>
inline T getStoredAverageEnergy(BlockLatticeBase3D<T,Descriptor> const& blockLattice) {
    return (T)0.5 * blockLattice.getInternalStatistics().getAverage (
                        LatticeStatistics::avUSqr );
}

template<typename T, template<typename U> class Descriptor>
inline T getStoredMaxVelocity(BlockLatticeBase3D<T,Descriptor> const& blockLattice) {
