...
namespace plb {
    ...
    template class OnLatticeBoundaryCondition3D<double, descriptors::D3Q19Descriptor>;
    ...
    template class
        ...
        <
            double, descriptors::D3Q19Descriptor,
            EquilibriumBoundaryManager3D < double, descriptors::D3Q19Descriptor >
        >;

    template OnLatticeBoundaryCondition3D<double,descriptors::D3Q19Descriptor>*
        createEquilibriumBoundaryCondition3D < double,descriptors::D3Q19Descriptor > ();
