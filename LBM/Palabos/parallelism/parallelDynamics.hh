...
template<typename T, template<typename U> class Descriptor>
void ParallelDynamics<T,Descriptor>::collide(Cell<T,Descriptor>& cell, BlockStatistics<T>& statistics_) {
...
template<typename T, template<typename U> class Descriptor>
void ParallelDynamics<T,Descriptor>::computeDeviatoricStress (
        Cell<T,Descriptor> const& cell, Array<T,SymmetricTensor<T,Descriptor>::n>& PiNeq ) const
{
    if (hasBulkCell) {
        baseCells[0] -> getDynamics().computeDeviatoricStress(*baseCells[0], PiNeq);
    }
...
template<typename T, template<typename U> class Descriptor>
void ParallelDynamics<T,Descriptor>::defineDeviatoricStress (
    Cell<T,Descriptor>& cell, Array<T,SymmetricTensor<T,Descriptor>::n> const& PiNeq)
{
    for (pluint iCell=0; iCell<baseCells.size(); ++iCell) {
        baseCells[iCell] -> defineDeviatoricStress(PiNeq);
    }
}
...
template<typename T, template<typename U> class Descriptor>
void ConstParallelDynamics<T,Descriptor>::collide(Cell<T,Descriptor>& cell, BlockStatistics<T>& statistics_)
{ }
...
template<typename T, template<typename U> class Descriptor>
void ConstParallelDynamics<T,Descriptor>::computeDeviatoricStress (
        Cell<T,Descriptor> const& cell, Array<T,SymmetricTensor<T,Descriptor>::n>& PiNeq ) const
{
    if (hasBulkCell) {
        baseCells[0] -> getDynamics().computeDeviatoricStress(*baseCells[0], PiNeq);
...
template<typename T, template<typename U> class Descriptor>
void ConstParallelDynamics<T,Descriptor>::defineDeviatoricStress (
    Cell<T,Descriptor>& cell, Array<T,SymmetricTensor<T,Descriptor>::n> const& PiNeq)
{ }
