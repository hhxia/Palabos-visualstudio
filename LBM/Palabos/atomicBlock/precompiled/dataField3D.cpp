...
template class ScalarFieldDataTransfer3D<double>;

template class TensorField3D<double, 3>; // for vectors
template class TensorFieldDataTransfer3D<double, 3>;
template class TensorField3D<double, 6>; // for symmetric tensors
template class TensorFieldDataTransfer3D<double, 6>;
template class TensorField3D<double, 9>; // for non-symmetric tensors
template class TensorFieldDataTransfer3D<double, 9>;
template class TensorField3D<double,19>; // for full populations
template class TensorFieldDataTransfer3D<double, 19>;
