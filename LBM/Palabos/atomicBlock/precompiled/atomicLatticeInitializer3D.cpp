...
#include "atomicBlock/atomicLatticeInitializer3D.h"
#include "atomicBlock/atomicLatticeInitializer3D.hh"
...
template void defineDynamics<double, descriptors::D3Q19Descriptor> (
        BlockLattice3D<double,descriptors::D3Q19Descriptor>& lattice, ScalarField3D<double>& boolMask,
